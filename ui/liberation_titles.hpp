class CfgSounds
{
	...
	//HEADSHOT_GF
	class HEADSHOT_Blow_it_out_your_ass{name = "HEADSHOT_Blow_it_out_your_ass";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Blow_it_out_your_ass.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Come_get_some{name = "HEADSHOT_Come_get_some";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Come_get_some.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Come_on{name = "HEADSHOT_Come_on";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Come_on.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Damn_i_m_good{name = "HEADSHOT_Damn_i_m_good";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Damn_i_m_good.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Eat_shit_and_die{name = "HEADSHOT_Eat_shit_and_die";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Eat_shit_and_die.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Game_over{name = "HEADSHOT_Game_over";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Game_over.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Gotta_hurt{name = "HEADSHOT_Gotta_hurt";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Gotta_hurt.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Holy_shit{name = "HEADSHOT_Holy_shit";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Holy_shit.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_It_hurts_to_be_you{name = "HEADSHOT_It_hurts_to_be_you";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_It_hurts_to_be_you.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_lets_rock{name = "HEADSHOT_lets_rock";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_lets_rock.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Make_day{name = "HEADSHOT_Make_day";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Make_day.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Mess{name = "HEADSHOT_Mess";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Mess.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Ooooh_thats_gotta_hurt{name = "HEADSHOT_Ooooh_thats_gotta_hurt";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Ooooh_thats_gotta_hurt.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_See_you_in_hell{name = "HEADSHOT_See_you_in_hell";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_See_you_in_hell.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Shake_it_baby{name = "HEADSHOT_Shake_it_baby";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Shake_it_baby.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Shit_happens{name = "HEADSHOT_Shit_happens";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Shit_happens.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Terminated{name = "HEADSHOT_Terminated";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Terminated.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Ugly{name = "HEADSHOT_Ugly";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Ugly.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Wasted{name = "HEADSHOT_Wasted";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Wasted.ogg", db0, 1.0};titles[] = {};};
	class HEADSHOT_Yippie_kaiay{name = "HEADSHOT_Yippie_kaiay";sound[] = {"Killfeed_GF\Headshot_Sounds\HEADSHOT_Yippie_kaiay.ogg", db0, 1.0};titles[] = {};};	
